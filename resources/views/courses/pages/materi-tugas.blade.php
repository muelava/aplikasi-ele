                            ...
                            <div class="card-header">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <p>{{ date('d M Y H:i', strtotime($tugas->expired_tugas)) }} WIB <span id="expired-tugas" class="text-warning"></span></p>
                                    </div>
                                </div>
                                <hr>
                            </div>
...
@section('page-js')
    ...
    @if ($tugas)
        <script>
            let expired_tugas = '{{ $tugas->expired_tugas }}';
    ...
    @if ($sub_tugas)
        <script>
            ...
            if (resultTmer < 1) {
                document.querySelector('#reminder-text').textContent = 'Tugas kamu sudah terkumpul.';
                $('#reminder-text').after(
                    `<div class="text-center"><a href="/files/tugas/{{ $sub_tugas->dok_tugas }}" target="_blank">{{ $sub_tugas->dok_tugas }}</a><p class="text-center text-success mt-1">Submited!</p></div>`
                )
