                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-2 mb-md-0">
                                <ul class="nav nav-pills flex-column nav-left">
                                    <!-- general -->
                                    <li class="nav-item">
                                        <a class="nav-link active" id="account-pill-profil" data-toggle="pill" href="#account-vertical-profil" aria-expanded="true">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <!-- general tab -->
                                            <div role="tabpanel" class="tab-pane active" id="account-vertical-profil" aria-labelledby="account-pill-profil" aria-expanded="true">
                                                <!-- header media -->
                                                <div class="media">
                                                    <a href="javascript:void(0);" class="mr-25">
                                                        <img src="{{ asset('admin/images/avatars/user.jpg') }}" id="account-upload-img" class="rounded mr-50" alt="profile image" height="80" width="80" />
                                                    </a>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="kelas" name="kelas" placeholder="kelas" value="{{ $siswa->kelas->kelas }}" readonly />
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="tel" class="form-control" id="no_handphone" name="no_handphone" placeholder="Nomor Handphone" value="{{ $siswa->no_handphone }}" />
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group form-password-toggle input-group-merge">
                                                                    <input type="password" class="form-control" id="account-old-password" name="password" placeholder="Masukkan Password saat ini" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group form-password-toggle input-group-merge">
                                                                    <input type="password" id="account-new-password" name="new-password" class="form-control" placeholder="Masukkan Password Baru" />
                                                                    <div class="input-group-append">
                                                                        <div class="input-group-text cursor-pointer">
                                                                            <i data-feather="eye"></i>
                                                                        </div>
