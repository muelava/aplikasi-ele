                    ...
                    <div class="card">
                      ...
                      @endif
                        <div class="card-header justify-content-start">
                            <button class="btn btn-primary mr-2" data-toggle="modal" data-target="#modal-tambah-siswa"><i data-feather="plus"></i> Tambah Data</button>
                                  ...
                                  <td except>
                                      <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" style="">
                                          ...
                                          <a class="dropdown-item" href="/administrator/data-siswa/hapus/{{ $siswa->id }}" onclick="return confirm('Apakah anda yakin ingin manghapus data guru {{ $siswa->nama }}?')">
