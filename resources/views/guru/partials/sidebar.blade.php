    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item {{ $active === 'beranda' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('guru-beranda') }}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Beranda">Beranda</span></a>
                </li>
                ...
                <li class="nav-item {{ $active === 'tugas' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('guru-daftar-tugas') }}"><i data-feather="clock"></i><span class="menu-title text-truncate" data-i18n="Daftar Tugas">Daftar Tugas</span></a>
                </li>
